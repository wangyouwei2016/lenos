...
public class ActivitiDemo {
    ...
    @Test
    public void test() {
        repositoryService.createDeployment().name("demo.bar").addClasspathResource("bpmn/demo.xml")
    ...
    public void leaveStart() {
        ...
        Deployment deployment = repositoryService.createDeployment()
            ...
            .addClasspathResource("bpmn/leave.bpmn").addClasspathResource("bpmn/leave.png").name("请假流程").deploy();
    ...
    public void queryProcdef() {
        ...
        for (ProcessDefinition pd : pds) {
            System.out.println("ID:" + pd.getId() + "\nNAME:" + pd.getName() + "\nKEY:" + pd.getKey() + "\nVERSION:"
                + pd.getVersion() + "" + "\nRESOURCE_NAME:" + pd.getResourceName() + ",DGRM_RESOURCE_NAME:"
    ...
    public void queryTaskBoss() {
        List<Task> taskList = taskService.createTaskQuery().taskAssignee("老板").list();
        for (Task task : taskList) {
    ...
    public void isRun() {
        ProcessInstance instance =
            runtimeService.createProcessInstanceQuery().processInstanceId("25001").singleResult();
        if (instance != null) {
    ...
    public void getTask() {
        List<Task> taskList =
            taskService.createTaskQuery().taskCandidateUser("acfc0e9232f54732a5d9ffe9071bf572").list();// .taskAssignee("王五").list();
    ...
    public void image() throws Exception {
        ...
        InputStream imageStream = diagramGenerator.generateDiagram(bpmnModel, "png", activeIds,
