        ...
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="cron" name="cron" lay-verify="cron" value="${job.cron}"
                               autocomplete="off" class="layui-input">
                    </div>
                    <div id="ms" class="layui-form-mid layui-word-aux">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="clazzPath" style="width: 300px;" value="${job.clazzPath}"
                               name="clazzPath" lay-verify="clazzPath" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="jobDesc" name="jobDesc" value="${job.jobDesc}" lay-verify="jobDesc"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
