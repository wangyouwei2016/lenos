        ...
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="text" id="beginTime" readonly disabled value="${leave.beginTime?string("yyyy-MM-dd")}"
                           name="beginTime" lay-verify="beginTime" placeholder="yyyy-MM-dd"
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="endTime" readonly disabled value="${leave.endTime?string("yyyy-MM-dd")}"
                               name="endTime" lay-verify="endTime" placeholder="yyyy-MM-dd" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" readonly disabled id="reason" value="${leave.reason}" style="width: 300px;"
                               name="reason" lay-verify="reason" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
