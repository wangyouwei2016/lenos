            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="text" id="beginTime" readonly value="${leave.beginTime?string("yyyy-MM-dd")}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="endTime" readonly value="${leave.endTime?string("yyyy-MM-dd")}"
                               class="layui-input">
                    </div>
                </div>
            </div>
